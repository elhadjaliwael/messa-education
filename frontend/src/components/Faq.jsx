...
function Faq({question, answer}) {
  ...
  return (
    <div className='bg-card rounded-2xl p-3 sm:p-4 md:p-6 w-full mt-4 sm:mt-7 flex justify-between'>
      <div className='flex flex-col w-full'>
        <p className='text-foreground font-primary text-base sm:text-lg font-bold'>{question}</p>
        {isOpen && (
          <>
