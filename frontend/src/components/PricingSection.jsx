  ...
  return (
    <div className='mt-10'>
        <div className='flex flex-col justify-center items-center'>
            ...
            <h2 className='text-copy font-primary text-xl sm:text-2xl md:text-3xl font-bold text-center'>Choose the <span className='text-primary'>Plan</span> that's Right for You</h2>
            <p className='text-copy-lighter text-base sm:text-base text-center mt-1 sm:mt-2 px-4 sm:px-0'>
