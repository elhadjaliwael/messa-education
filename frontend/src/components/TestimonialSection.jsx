    ...
    <div>
        <div className='px-4 sm:px-8 md:px-10 lg:px-12 mt-10 flex flex-col items-center justify-center'>
            <div className='flex flex-col items-center justify-center w-full max-w-[500px] text-center'>
                ...
                <h1 className='text-2xl sm:text-3xl font-bold font-primary text-foreground'>What Our <span className='text-primary'>Students Say</span></h1>
                <p className='text-muted-foreground text-base sm:text-sm mt-2 px-2 sm:px-0'>Don't just take our word for it. Hear from some of our successful students who have transformed their lives through our platform.</p>
            </div>
        </div>
