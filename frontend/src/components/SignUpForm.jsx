        ...
        <div>
            ...
            <form onSubmit={formAction}>
                <div className='flex flex-col gap-2 m-5'>
                    <input
                        className={`border-2 ${errors.username ? 'border-red-500' : 'border-border'} rounded-xl p-2 placeholder:text-muted-foreground placeholder:font-light caret-foreground text-foreground`}
                        placeholder='Name'
                        name="username"
                ...
                <div className='flex flex-col gap-2 m-5'>
                    <input
                        className={`border-2 ${errors.email ? 'border-red-500' : 'border-border'} rounded-xl p-2 placeholder:text-muted-foreground placeholder:font-light caret-foreground text-foreground`}
                        placeholder='Email'
                        name="email"
                ...
                <div className='flex flex-col gap-2 m-5'>
                    ...
                    >
                        <SelectTrigger 
                            className={`w-full border-2 ${errors.level ? 'border-red-500' : 'border-border'} rounded-xl p-2 placeholder:text-muted-foreground placeholder:font-light caret-foreground text-foreground h-[40px] bg-background`}
                        >
                    ...
                    {errors.class && <p className='text-red-500 text-sm'>{errors.level}</p>}
                </div>
                
                <div className='flex flex-col gap-2 m-5'>
                    <div className='relative'>
                        <input
                            className={`border-2 w-full ${errors.password ? 'border-red-500' : 'border-border'} rounded-xl p-2 placeholder:text-muted-foreground placeholder:font-light caret-foreground text-foreground`}
                ...
                <button type="submit" className='cursor-pointer bg-primary m-5 text-primary-foreground font-primary font-medium w-[90%] h-[40px] rounded-xl'>
                    Sign Up
                </button>
            </form>
